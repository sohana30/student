    ...
    public function getAllStudents() {
      ...
      public function updateStudent(Request $request, $id) {
        if (Student::where('id', $id)->exists()) {
          ...
          $student->student_number = is_null($request->student_number) ? $student->student_number : $request->student_number;
          ...
          $student->comapny_id = is_null($request->company_id) ? $student->comapny_id : $request->company_id;
